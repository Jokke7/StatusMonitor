...
namespace ValidStatusMonitor.Migrations
{
    ...
    [Migration("20190527065352_ResourceLinksAdded_statusTable")]
    partial class ResourceLinksAdded_statusTable
    {
            ...
            modelBuilder.Entity("ValidStatusMonitor.Models.InstallationStatus", b =>
                {
                    ...
                    b.Property<string>("AppLicenceLink")
                        .HasColumnName("LICENCE_LINK");
